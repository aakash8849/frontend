  ...
  const handleSubmit = async () => {
    ...
    try {
      if (isVisualizeMode) {
        ...
        if (!data) {
          setError('No data found for this token. Please analyze it first.');
          return;
        }
        ...
        setHasExistingData(response.data.existingData);
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="bg-white rounded-lg shadow p-6 mb-6">
        ...
        {hasExistingData && !isVisualizeMode && (
          <div className="mb-4 p-4 bg-blue-50 text-blue-700 rounded-md">
            Existing data found for this token. Analysis will update the current data.
          </div>
        )}
        ...
        >
          {status === 'in_progress' ? 'Analysis in Progress...' : 
           ...
           isVisualizeMode ? 'Visualize Data' : 
           hasExistingData ? 'Update Data' : 'Fetch Data'}
        </button>
